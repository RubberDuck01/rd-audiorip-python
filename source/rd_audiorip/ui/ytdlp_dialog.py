...
class YtdlpDialog(QDialog):
    def __init__(self, parent=None) -> None:
        ...
        status_form.addRow("Target path:", QLabel(str(get_tools_ytdlp_path())))
        ...
        self.update_btn = QPushButton("Update (yt-dlp -U)")
    ...
    def refresh_version(self) -> None:
        ...
        self.install_status_value.setText("Installed" if target_installed else "Not installed")
